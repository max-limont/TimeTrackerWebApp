...
import { endWith, from, map, mergeMap, startWith } from "rxjs";
...
import { logOut, setLoadingState, setToken } from "../../../../store/slice/authentication/authSlice";
    ...
    return action$.pipe(
        ...
        mergeMap((action: any) => from(defaultRequest(authUserQuery, {
            ...
            .pipe(
                ...
                startWith(setLoadingState(true)),
                endWith(setLoadingState(false))
                )));
}
